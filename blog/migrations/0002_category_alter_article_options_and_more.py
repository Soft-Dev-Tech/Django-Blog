# Generated by Django 4.2.9 on 2024-01-17 17:16
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='article',
            name='publish',
            field=models.DateTimeField(default=django.utils.timezone.now, verbose_name='زمام انتشار'),
        ),
        migrations.AlterField(
            model_name='article',
            name='slug',
        ...
        migrations.AlterField(
            model_name='article',
            name='status',
            field=models.CharField(choices=[('d', 'پیش نویس'), ('p', 'منتشر شده')], max_length=1, verbose_name='موضوعات'),
        ),
        migrations.AlterField(
            model_name='article',
            name='thumnail',
